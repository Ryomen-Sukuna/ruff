...
var = [1, 2, 3][1.2:2]
var = [1, 2, 3][{"x"}:2]
var = [1, 2, 3][set(range(2)):2]
var = [1, 2, 3][{"x": x for x in range(2)}:2]
var = [1, 2, 3][list(range(2)):2]
...
var = [1, 2, 3][:1.2]
var = [1, 2, 3][:{"x"}]
var = [1, 2, 3][:set(range(2))]
var = [1, 2, 3][:{"x": x for x in range(2)}]
var = [1, 2, 3][:list(range(2))]
...
var = [1, 2, 3][0:1:1.2]
var = [1, 2, 3][0:1:{"x"}]
var = [1, 2, 3][0:1:set(range(2))]
var = [1, 2, 3][0:1:{"x": x for x in range(2)}]
var = [1, 2, 3][0:1:list(range(2))]
