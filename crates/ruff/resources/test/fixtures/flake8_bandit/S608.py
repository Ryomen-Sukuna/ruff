...
query = f"INSERT table VALUES ({var})"

# # REPLACE (e.g. MySQL and derivatives, SQLite)
query = f"REPLACE INTO table VALUES ({var})"
query = f"REPLACE table VALUES ({var})"

query = "Deselect something that is not SQL even though it has a ' from ' somewhere in there."
